...
[![Project Status](https://img.shields.io/badge/status-early%20development-blue.svg)](#current-project-status)
...
> 🔵 **ResearchForge is in early development under IEEE Summer of Code 2026.** The tech stack is finalized and project scaffolding is underway. No runnable application exists yet.

| Area | Status | Active Milestone |
|---|---|---|
| Repository & Community Setup | ✅ Complete | M0 |
| Tech Stack & Architecture | ✅ Finalized | M1 |
| Project Scaffolding | 🟡 In Progress | M1.5 |
...
| **M1.5** | Project Scaffolding | 🟡 In Progress |
...
- [docs/DeveloperGuide.md](docs/DeveloperGuide.md) — Local development setup
...
👉 **Next Step:** Ready to contribute? Start with **[docs/GettingStarted.md](docs/GettingStarted.md)** *(⏱️ ~5 min read)*!
